...
public  class NoteBytesVideo extends NoteBytes {
    public NoteBytesVideo(byte[] videoData) {
        super(videoData, NoteBytesMetaData.RAW_BYTES_TYPE);
    }
    public NoteBytesVideo(Path videoPath) throws IOException {
        super(videoToBytes(videoPath), NoteBytesMetaData.RAW_BYTES_TYPE);
    }
